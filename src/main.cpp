...
/*    last1 = boost::posix_time::microsec_clock::universal_time();
    last2 = boost::posix_time::microsec_clock::universal_time();
    last3 = boost::posix_time::microsec_clock::universal_time();
    last5 = boost::posix_time::microsec_clock::universal_time();
*/
